(defproject quiz-site "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "quiz-site.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main quiz-site.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "quiz-site.core/on-figwheel-reload"}

                :compiler {:main quiz-site.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/quiz_site.js"
